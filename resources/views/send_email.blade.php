...
<body>
    ...
    <form action="POST" action "{{  url('sendemail/send') }}">
        ...
        <div class="form-group">
        <label  class="lang"  key="forma3" required><b>Enter Your Email</b></label></br>
        <input type="text" name="email" class="form-control" placeholder="example@example.com" name="phone" required>
